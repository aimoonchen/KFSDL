		...
		if (_event)
		{
			...
			switch (_eventType)
			{
				case EMSCRIPTEN_EVENT_TOUCHSTART:
					s_ctx.m_eventQueue.postMouseEvent(kDefaultWindowHandle, s_ctx.m_mx, s_ctx.m_my, 0);
					s_ctx.m_eventQueue.postMouseEvent(kDefaultWindowHandle, s_ctx.m_mx, s_ctx.m_my, 0, MouseButton::Left, true);
					bx::printf("EMSCRIPTEN_EVENT_TOUCHSTART\n");
					return true;
				case EMSCRIPTEN_EVENT_TOUCHEND:
					s_ctx.m_eventQueue.postMouseEvent(kDefaultWindowHandle, s_ctx.m_mx, s_ctx.m_my, 0, MouseButton::Left, false);
